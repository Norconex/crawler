 ...
 */
package com.norconex.committer.googlecloudsearch.spi;
...
import com.norconex.committer.googlecloudsearch.GoogleCloudSearchCommitter;
 ...
 * </p>
 */
public class GoogleCloudSearchCommitterPtProvider
    ...
    public MultiValuedMap<Class<?>, Class<?>> getPolymorphicTypes() {
        ...
        map.put(Committer.class, GoogleCloudSearchCommitter.class);
        return map;
    }
}
