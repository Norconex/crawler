...
| BoxFetcher         | `box://`                                            | `box://my-enterprise/folders/0`                                                      | Set `accessToken`; keep default `apiBaseUrl` unless custom       |
| EgnyteFetcher      | `egnyte://`                                         | `egnyte://acme/folders/root`                                                         | Set `accessToken`; keep `{domain}` in `apiBaseUrl` unless custom |
