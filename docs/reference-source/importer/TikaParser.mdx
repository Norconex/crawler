...
Path to a [Tika configuration file](https://tika.apache.org/3.2.3/configuring.html), giving you Tika's own parser selection and settings. Without it, Tika's defaults apply.
